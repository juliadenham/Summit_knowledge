...
Baltimore classification is chiefly based on the
...
[replicating](Viral_replication "wikilink") the viral genome. Because
...
such as a [polyadenylation](polyadenylation "wikilink") site.
...
of each other, is widely used. A rolling circle mechanism that
produces linear strands while progressing in a loop around the circular
genome is also common. Some dsDNA viruses use a strand displacement
...
strand, forming a dsDNA genome. Lastly, some dsDNA viruses are
...
dsDNA viruses can be subdivided between those that replicate in the
...
-   All viruses in *Adnaviria* are dsDNA viruses. Viruses in this realm
    infect [archaea](archaea "wikilink").
-   All viruses in *Duplodnaviria* are dsDNA viruses. Viruses in this
    ...
    *[Herpesvirales](Herpesvirales "wikilink")*.
-   In *Monodnaviria*, members of the class
    *[Papovaviricetes](Papovaviricetes "wikilink")* are dsDNA viruses.
    ...
    [polyomaviruses](polyomavirus "wikilink").
-   All viruses in *Varidnaviria* are dsDNA viruses. Viruses in this
    ...
    [poxviruses](poxvirus "wikilink").
-   The following taxa that are unassigned to a realm exclusively
    contain dsDNA viruses:
    -   Classes: *[Naldaviricetes](Naldaviricetes "wikilink")*
...
cell or as a consequence of replication of the viral genome.
...
continuation of the replication cycle.
...
packaged into capsids, varying from virus to virus.
...
or negative sense strand into virions. Lastly,
[bidnaviruses](Bidensovirus "wikilink") package both the positive and
negative linear strands. In any case, the sense of ssDNA viruses,
...
forms prior to transcription and replication.
...
-   Viruses in the family
    *[Finnlakeviridae](Finnlakeviridae "wikilink")* contain ssDNA
    ...
    proposed member of *Varidnaviria*.
...
a mature capsid to a progeny capsid. While dsRNA viruses typically
...
*Orthornavirae* of the realm *Riboviria*:
...
for sgRNA synthesis, RdRp is always translated first.

Because the process of replicating the viral genome produces
...
is reached. The second manner is similar but instead of synthesizing
...
cap of the viral mRNA. Genomic -ssRNA is replicated from the
...
transcription signals when synthesizing genomic -ssRNA.
...
mRNA. Additionally, some -ssRNA viruses are ambisense, as both the
...
genome and one from a complementary strand.

-ssRNA viruses can be subdivided informally between those that have
...
synonymous with *Negarnaviricota*. *Negarnaviricota* is divided into
...
its replication cycle. ssRNA-RT viruses are transcribed in the same
...
manner as dsDNA viruses, but make use of reverse transcription to
...
which is the sole family in the order *Blubervirales*.
...
exporting their unspliced genomic RNA out of the nucleus.
...
ssDNA and the other dsDNA. Viruses in the ssDNA [plant
...
viruses are only found in eukaryotes.
...
linear, and dsDNA-RT viruses are typically circular. In the
...
circular genomes, varying from genus to genus.
...
-   Non-canonical translation initiation:
    -   Viral initiation of translation: used primarily by +ssRNA and
        ...
        with a [leucine](leucine "wikilink") amino acid.
    -   [Leaky scanning](Leaky_scanning "wikilink"): used by various
        ...
        start codon.
    -   [Ribosomal shunting](Ribosomal_shunting "wikilink"): used by
        ...
        downstream from the leader sequence.
...
-   Non-canonical elongation and termination of translation:
    ...
    -   Suppression of termination: also called stop-codon readthrough,
        ...
        protein. In viruses, this is often used to express
...
was later expanded to include group VII. Because of the utility
...
ICTV. As part of this, the Baltimore groups for RNA viruses and RT
...
groups. A year later, *Riboviria* was expanded to also include both
...
defining characteristics of the phyla in *Orthornavirae*.
...
and *Duplodnaviria* exclusively contains dsDNA viruses,
*Monodnaviria* primarily contains ssDNA viruses but also contains dsDNA
viruses, and *Varidnaviria* exclusively contains dsDNA viruses,
although some proposed members of *Varidnaviria*, namely the family
*[Finnlakeviridae](Finnlakeviridae "wikilink")*, are ssDNA viruses.