...
Islands](Galápagos_Islands "wikilink"). Its diet mainly consists of
...
siblicide](siblicide "wikilink") in times of food scarcity. This
...
current [binomial name](binomial_name "wikilink") *Sula nebouxii*.
...
Neboux](Adolphe-Simon_Neboux "wikilink") (1806–1844). There are two
recognized [subspecies](subspecies "wikilink"):

- The subspecies S. n. nebouxii is distributed across the Pacific coast of Southern and Middle America.
- The subspecies S. n. excisa Todd, 1948 is distributed across the Galápagos Islands.
...
shared ecological and biological characteristics. A 2011 study of
...
clumsy on land. They are also regarded as foolish for their apparent
...
white plumage. Its eyes are placed on either side of its bill and
...
females. Its blue feet play a key role in courtship rituals and
...
Galápagos Islands south into Peru. It is strictly a marine bird. Its
only need for land is to breed and rear young, which it does along the
rocky coasts of the eastern Pacific.

A booby may use and defend two or three nesting sites, which consist of
...
off and landing. Bigamy has been observed in the species, and cases
are known where two females and one male all share a single nest.
...
state. Blue feet also indicate the current health condition of a
...
a booby's current level of nourishment. As blue feet are signals
...
foster males with duller feet. Females continuously evaluate their
...
contained less yolk [androgens](androgens "wikilink"). As androgen
plays an important role in chick survival, the experiment suggested
female blue-footed boobies use the attractiveness and perceived genetic
quality of their mates to determine how much resources they should
allocate to their eggs. This supports the differential allocation
theory, which predicts that parents care more for their offspring when
paired with attractive mates.
...
females exhibited both bright feet and high-quality offspring.
...
enormous pressure. Prey are usually eaten while the birds are still
under water. Individuals prefer to eat on their own instead of with
their hunting group, usually in the early morning or late afternoon.
...
although it has the potential to be bigamous. It is an
[opportunistic breeder](opportunistic_breeder "wikilink"), with the
breeding cycle occurring every 8 to 9 months. The
...
display of his feet. The dance also includes "sky-pointing", which
involves the male pointing his head and bill up to the sky while keeping
the wings and tail raised.
...
specialized diving. The female takes over when the demand is higher.
...
ensuring that at least one will survive.
...
in that they had lower masses and shorter wing lengths.
...
nestlings with different aged parents are least infected by ticks.

#### Brood hierarchy due to asynchronous hatching

The blue-footed booby lays one to three eggs in one nest at a time,
although 80% of nests only contain two eggs. Eggs are laid five days
...
offspring when resources are insufficient to properly do so.
...
the first two months of life. During lean times, the A-chick may
...
B-chicks to defend themselves against an A-chick attack.
...
However, another experiment showed that booby chicks do not operate
...
parents. The "insurance egg hypothesis" views the second egg and
resulting chick as insurance for the parent in case the first egg does
not hatch, or if food levels are higher than expected.
...
steepness. Blue-footed booby chicks that were placed in masked booby
nests were more likely to engage in siblicide, which reveals that
parental care somehow affects the level of siblicide. Parents also
appear to respond more frequently to chicks that are in poorer body
conditions during periods of food deprivation. Egg-mass analysis
...
the second egg. Hormonal analysis of eggs also shows that no
...
maximize parental reproductive output. What may at first appear to
...
nests of their own before their dominant siblings.
...
females can discriminate the calls of their mates from others.
...
April 2014, confirmed the population decline. The blue-footed booby
...
such as effects of humans, introduced predators, or disease.