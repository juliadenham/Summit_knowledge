...
Though originally placed in the genus *[Parus](Parus "wikilink")* with
...
chickadee species, a subset of genus *Poecile*:
...
-   *Poecile atricapillus practicus*
    ...
    mountains](Appalachian_mountains "wikilink") in the eastern U.S.
...
differentiate sexes. Males have a wing length of , a tail length of
...
length of , and a tarsus length of . Both sexes weigh . Juveniles
are visually similar to adults but with fluffier plumage.
...
Black-capped chickadees make a number of other calls and sounds, such as
...
typically most common at elevations below , although they have been
known to occur at up to .

Black-capped chickadees inhabit wooded areas, including both
...
weather when the temperature drops below for more than five days. In
...
typically short bursts of less than with a speed around . They tend
to avoid flying through large open areas and will instead be found
flying along tree-lines or through forests.
...
The black-capped chickadee nests in tree cavities above ground. The
...
finer material such as mammal hair. The nesting season is from late
...
only, which is fed by the male. If an unusual disturbance occurs at
