...
approximately 80% of the world's crop pollination services.

Worker bees are the caste of bee that perform most of the fundamental
tasks of the hive, and they are by far the most numerous type of bee.
...
cells and evaporated into [honey](honey "wikilink").
...
hive's brood chamber within a range of 34-36 celsius vs fahrenheit 
(93.2-96.8 degrees Fahrenheit). If the
...
warmed muscles against caps or walls of brood cells. In the
wintertime, worker bees can [cluster
together](Winter_cluster "wikilink") to generate body heat to keep the
brood area warm as external temperature decreases.
...
Honey bees begin as an egg laid by the queen in the brood nest, located
...
days, followed by pollen and honey for about two more days until the
...
grown bee, immediately beginning its roles in the hive.
...
estimated number of days each worker bee will spend at each task. 
...
the hive around 10 times each day, with each trip lasting an hour.

## Worker activities in the hive

### Honey production

Worker bees collect nectar from flowers using their tubular mouth parts,
...
prevents absorption of moisture from the air.
...
they feed themselves from the honey supply. 
...
honey production and brood space.
...
in the bee *[Melipona
scutellaris](Melipona_scutellaris "wikilink").* Geopropolis displays
...
cancer cell lines at low concentrations compared to normal cells.
...
airflow into the hive or out of the hive depending on need.
...
spread on the backs of fanning bees.
...
providing more protection against intruders.

## Genetic characteristics

In most common bee species, worker bees are infertile due to enforced
altruistic [kin selection](kin_selection "wikilink"), and thus never
...
they are exposed to and the environmental landscape is shown to
...
itself and the hive from most mammals. [Bee
...
The [barbs](wikt:barb "wikilink") on the stinger will not catch on most
